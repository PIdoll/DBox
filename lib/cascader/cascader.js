...
function defaultFilterOption(inputValue) {
...
function defaultRenderFilteredOption(inputValue) {
  var path = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : [];
  var prefixCls = arguments[2];
  ...
  (0, _createClass3.default)(Cascader, [{
    ...
    value: function render() {
      ...
      var prefixCls = props.prefixCls,
          ...
          otherProps = (0, _objectWithoutProperties3.default)(props, ['prefixCls', 'inputPrefixCls', 'children', 'placeholder', 'size', 'disabled', 'className', 'style', 'allowClear', 'autoFocus', 'showSearch']);
      ...
      var autoFocusClass = (0, _classnames2.default)((0, _defineProperty3.default)({}, prefixCls + '-input-autoFocus', autoFocus));
      var clearIcon = allowClear && !disabled && value.length > 0 || state.inputValue ? React.createElement(_icon2.default, {
        type: 'close-circle',
        className: prefixCls + '-picker-clear',
        onClick: this.clearSelection
      }) : null;
      var arrowCls = (0, _classnames2.default)((_classNames3 = {}, (0, _defineProperty3.default)(_classNames3, prefixCls + '-picker-arrow', true), (0, _defineProperty3.default)(_classNames3, prefixCls + '-picker-arrow-expand', state.popupVisible), _classNames3));
      var pickerCls = (0, _classnames2.default)(className, prefixCls + '-picker', (_classNames4 = {}, (0, _defineProperty3.default)(_classNames4, prefixCls + '-picker-with-value', state.inputValue), (0, _defineProperty3.default)(_classNames4, prefixCls + '-picker-disabled', disabled), (0, _defineProperty3.default)(_classNames4, prefixCls + '-picker-' + size, !!size), _classNames4));
      ...
      var expandIcon = React.createElement(_icon2.default, { type: 'pro-right' });

      var loadingIcon = React.createElement(
        'span',
        { className: prefixCls + '-menu-item-loading-icon' },
        React.createElement(_icon2.default, { type: 'loading' })
      );
      ...
      var input = children || React.createElement(
        ...
        React.createElement(_input2.default, (0, _extends3.default)({}, inputProps, {
          ref: this.saveInput,
...
Cascader.propTypes = {
  ...
  matchInputWidth: _propTypes2.default.number,
