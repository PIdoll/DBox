...
var FormItem = function (_React$Component) {
  ...
  function FormItem() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = FormItem.__proto__ || (0, _getPrototypeOf2.default)(FormItem)).call.apply(_ref, [this].concat(args))), _this), _this.onLabelClick = function () {
      ...
      if (controls.length !== 1) {
        var control = _reactDom2.default.findDOMNode(_this).querySelector('[id="' + id + '"]');
  ...
  (0, _createClass3.default)(FormItem, [{
    ...
    value: function renderLabel() {
      ...
      var labelColClassName = (0, _classnames2.default)(labelCol && labelCol.className, formType === 'compact' ? prefixCls + '-item-label-compact' : prefixCls + '-item-label');
    ...
    value: function renderFormItem(children) {
      ...
      var itemClassName = (_itemClassName = {}, (0, _defineProperty3.default)(_itemClassName, prefixCls + '-item', true), (0, _defineProperty3.default)(_itemClassName, prefixCls + '-item-with-help', !!this.getHelpMsg()), (0, _defineProperty3.default)(_itemClassName, prefixCls + '-item-no-colon', !props.colon), (0, _defineProperty3.default)(_itemClassName, '' + props.className, !!props.className), (0, _defineProperty3.default)(_itemClassName, prefixCls + '-item-compact', props.formType === 'compact'), _itemClassName);
...
FormItem.propTypes = {
  ...
  formType: _propTypes2.default.string // 紧凑型表单使用
};
