...
var _triggerEventer = require('../_util/triggerEventer');

var _triggerEventer2 = _interopRequireDefault(_triggerEventer);
...
var TransferList = function (_React$Component) {
  ...
  function TransferList(props) {
    ...
    var _this = (0, _possibleConstructorReturn3.default)(this, (TransferList.__proto__ || (0, _getPrototypeOf2.default)(TransferList)).call(this, props));
    ...
    _this.handleFilter = function (e) {
      ...
      _this.triggerScrollTimer = window.setTimeout(function () {
        var transferNode = _reactDom2.default.findDOMNode(_this);
        var listNode = transferNode.querySelectorAll('idoll-transfer-list-content')[0];
        if (listNode) {
          (0, _triggerEventer2.default)(listNode, 'scroll');
        }
      }, 0);
      _this.fixIERepaint();
    };
  ...
  (0, _createClass3.default)(TransferList, [{
    ...
    value: function fixIERepaint() {
      ...
      this.fixIERepainTimer = window.setTimeout(function () {
    ...
    value: function render() {
      ...
      var checkAllCheckbox = _react2.default.createElement(_checkbox2.default, {
        ref: 'checkbox',
        disabled: disabled,
        checked: checkedAll,
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'span',
              null,
              (checkedKeys.length > 0 ? checkedKeys.length + '/' : '0/') + totalDataSource.length,
              ' ',
              unit
            ),
            _react2.default.createElement(
