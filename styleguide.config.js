...
module.exports = {
  ...
  usageMode: 'hide',
    ...
    TableOfContentsRenderer: path.join(__dirname, 'styleguide/components/SearchComponentList.js'),
  //  PlaygroundRenderer: path.join(__dirname, 'styleguide/components/playground'),
    ComponentsListRenderer: path.join(__dirname, 'styleguide/components/componentListRenderer'),
      ...
      sections: [
        ...
        },
        {
          ...
          components: () => ([
            ...
            path.resolve(__dirname, './components/empty/index.jsx'),
