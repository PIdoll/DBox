  ...
  render () {
    ...
    return (
      <div id='main-container'>
        ...
        <h1 className='h1'>更多分页,改变每页显示条数目</h1>
        <p>依据默认选中页defaultCurrent和总条数total来控制,其值均为number类型,showSizeChanger为布尔值可控制显示改变每页显示条数目</p>
...
//   <div id='main-container'>
//     <h1 className='h1'>基础分页</h1>
//     <p>依据默认选中页defaultCurrent和总条数total,值均为number类型</p>
//     <Pagination defaultCurrent={1} total={50} />
//     <h1 className='h1'>更多分页,改变每页显示条数目</h1>
//     <p>依据默认选中页defaultCurrent和总条数total,值均为number类型,showSizeChanger为布尔值可控制显示改变每页显示条数目</p>
//     <Pagination defaultCurrent={6} total={500} showSizeChanger />
//     <h1 className='h1'>跳转分页</h1>
//     <p>依据默认选中页defaultCurrent和总条数total,值均为number类型，showQuickJumper为布尔值可控制跳转分页显示</p>
//     <Pagination defaultCurrent={2} total={500} showQuickJumper />
//     <h1 className='h1'>迷你分页</h1>
//     <p>依据默认选中页defaultCurrent和总条数total,值均为number类型，defaultCurrent不传参默认选中第一个，total为必写，通过size='small'控制迷你版，其他参数同上</p>
//     <Pagination size='small' total={50} /><br />
//     <Pagination size='small' total={50} showSizeChanger showQuickJumper /><br />
//     <Pagination size='small' total={50} showTotal={showTotal} /><br />
//     <h1 className='h1'>简洁翻页</h1>
...
//     <h1 className='h1'>包含总数</h1>
//     {/* <Pagination showTotal={(total, range) => (`总共${total}条数据,${range[0]}-${range[1]}`)} defaultCurrent={2} total={5000} pageSize={50} showQuickJumper /> */}
//     <Pagination showTotal={(total, range) => (`总共${total}条数据`)} defaultCurrent={2} total={5000} pageSize={50} showQuickJumper />
//     {/* <h1 className='h1'>上一页和下一页</h1>
//     <Pagination defaultCurrent={2} total={5000} itemRender={itemRender} /> */}
//   </div>
//   )
